...
ALLOWED_EXTENSIONS = {"txt", "pdf", "png", "bmp", "jpg", "jpeg", "gif"}
...
if __name__ == "__main__":
    ...
    uploaded_file = st.file_uploader("Choose a image file", type=["png", "bmp", "jpg", "jpeg", "gif"])
    if uploaded_file is not None:
        conf_thres = st.slider("Object Xonfidence Threshold", 0.2, 1., step=0.05)
